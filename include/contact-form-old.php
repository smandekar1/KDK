...
if( $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if($email != '') {
                ...
                // $mail->Host = 'smtp.bizmail.yahoo.com';                  // Specify main and backup SMTP servers, example: smtp1.example.com;smtp2.example.com
                // $mail->SMTPAuth = true;                               // Enable SMTP authentication
                // $mail->Username = 'webmaster@kdkforging.com';                    // SMTP username
                ...
                $mail->From = "webmaster@kdkforging.com";
